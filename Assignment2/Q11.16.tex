...
\begin{align}
P(X=k)=P_X(k) = \binom{4}{k}(0.5)^k(0.5)^{4-k} = \binom{4}{k}(0.5)^4
\end{align}
So, the different cases are:
\begin{enumerate}
\item $ X=0(Y=4)\\
A = (2.5 \times 0)-6=-6\\
P_X(0)=\binom{4}{0}(0.5)^4=0.0625$
\vspace{1cm}
\item $ X=1(Y=3)\\
A = (2.5 \times 1)-6=-4.5\\
P_X(1)=\binom{4}{1}(0.5)^4=0.25$
\vspace{1cm}
\item  $X=2(Y=2)\\
A = (2.5 \times 2)-6=-1\\
P_X(2)=\binom{4}{2}(0.5)^4=0.375$
\vspace{1cm}
\item $ X=3(Y=1)\\
A = (2.5 \times 3)-6=1.5\\
P_X(3)=\binom{4}{3}(0.5)^4=0.25$
\vspace{1cm}
\item $ X=4(Y=0)\\
A = (2.5 \times 4)-6=4\\
P_X(4)=\binom{4}{4}(0.5)^4=0.0625$
\end{enumerate}
So, these will be the possible outcomes and their probabilities.
