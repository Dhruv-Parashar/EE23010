...
\\
\solution
Since coin is tossed four times, so the possible sample space:\\
...
\begin{align}
 ...
 \end{align}
So, he wins Rs $4$
\item For three heads and one tail: 
\begin{align}
 1+1+1-1.5 =  1.5
 \end{align}
So, he wins Rs $1.5$
\item For two heads and two tails:
\begin{align}
 1+1-1.5-1.5 =  -1
 \end{align}
 So, he looses Rs $1$
 \item For one head and three tails:
\begin{align}
 1-1.5-1.5-1.5 = -4.5
 \end{align}
 So, he looses Rs $4.5$
...
Then, n(S) = $16$\\
\begin{align}
p_X(\text{winning Rs}4) &=\frac{1}{16}\\
p_X(\text{winning Rs}1.5) &=\frac{4}{16}=\frac{1}{4}\\
p_X(\text{loosing Rs}1) &=\frac{6}{16}=\frac{3}{8}\\
p_X(\text{loosing Rs}3.5) &=\frac{4}{16}=\frac{1}{4}\\
p_X(\text{loosing Rs}1.5) &=\frac{1}{16}
\end{align}
\end{document}
