...
$H\brak{X}$ & Entropy & $H\brak{X} = -\sum p_X\brak{k} \log p_X\brak{k}$ \\\hline
\end{tabular}
\begin{align}
C &=\text{max}_{p\brak{X,Y}} I\brak{X,Y}\\
I\brak{X,Y} &= H\brak{Y} - H\brak{\left.{Y}|\right.{X}}\\
&= \log_23 + \alpha\log_2\alpha+\brak{1-\alpha}\log_2\brak{1-\alpha}\\
