...
$p_X\brak{x}$ & Input probability & $ p_X\brak{0}, p_X\brak{1}, p_X\brak{2} $\\\hline
$p_Y\brak{y}$ & Output probability & $ p_Y\brak{0}, p_Y\brak{1}, p_Y\brak{2} $\\\hline
...
Now,
\begin{align}
\sum_{x=0}^2p_X\brak{x}&=1\\
 \sum_{y=0}^2p_Y\brak{y}&=1\\
H\brak{Y} &= - \sum_{y=0}^2p_Y\brak{y} \log_2p_Y\brak{y}\label{eq:2}\\
...
&=-\sum_{y=0}^2p_{Y}\brak{{\left.{y}|\right.{x}}}\log_2\brak{p_{Y}\brak{{\left.{y}|\right.{x}}}}\label{eq:3}
\end{align}
Using \eqref{eq:2} and \eqref{eq:3} in \eqref{eq:1}
\begin{align}
I\brak{X,Y}&= - \sum_{y=0}^2p_Y\brak{y} \log_2p_Y\brak{y}+\sum_{y=0}^2p_{Y}\brak{{\left.{y}|\right.{x}}}\log_2\brak{p_{Y}\brak{{\left.{y}|\right.{x}}}}
\end{align}
\end{document}
